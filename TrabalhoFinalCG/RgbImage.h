...
private:
	...
	static void writeLong(long data, FILE* outfile); //tirei o RgbImage:: antes do writeLong
	static void writeShort(short data, FILE* outfile); //tirei o RgbImage:: antes do writeLong
